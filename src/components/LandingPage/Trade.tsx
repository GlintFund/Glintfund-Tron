...
const Trade = () => {
  ...
  <section className='section  bg-gradient-to-b from-[#f8f9fb] to-[#fafbff] text-customPurple'>
    <div className='container mx-auto'>
      <h2 className='section-title text-center mb-16'>Raise funds with multiple Tron-compatible tokens like TRX, USDT, JST, and more.</h2>
        {/* items */}
        <div className='flex flex-col gap-[45px] lg:flex-row'>
          {currency.map ((item, index)=> {
            ...
            return( 
              ...
              cursor-pointer transition duration-300 hover:bg-customPurple hover:text-white ' key={index}>
