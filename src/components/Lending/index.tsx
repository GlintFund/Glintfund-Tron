        ...
        <SidebarDemo>
            <div className="mx-4">
                ...
                <div className="flex flex-row justify-evenly my-3">
                    <div className="flex gap-x-3 w-[50%] justify-center items-center border border-gray-400 rounded-xl py-2 px-6 ">
...
function Card () {
    return (
        <div className="border bg-customPurple border-transparent rounded-xl flex flex-row justify-between items-center px-3 py-2 my-3">
            <div>
                <p>BNB</p>
...
function HistoryCard () {
    return (
        <div className="border bg-customPurple bg-b border-transparent rounded-xl flex flex-col justify-start items-start px-3 py-2 my-3 ">
