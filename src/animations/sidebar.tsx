...
export const DesktopSidebar = ({
  ...
  return (
    <>
      <motion.div
        className={cn(
          "h-full px-4 py-4 hidden  md:flex md:flex-col bg-[#EBD3F7] w-[300px] flex-shrink-0 font-sans",
          className
        )}
        animate={{
...
export const MobileSidebar = ({
  ...
  return (
    <>
      <div
        className={cn(
          "h-10 px-4 font-sans py-4 flex flex-row md:hidden  items-center justify-between bg-[#EBD3F7] w-full"
        )}
        {...props}
      >
